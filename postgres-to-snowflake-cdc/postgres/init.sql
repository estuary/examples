...
-- that the traffic generator writes to.

-- ---------------------------------------------------------------------------
-- The table we capture from.
-- event_ts records when each change happened, which lets us measure
-- end-to-end latency in Snowflake later instead of guessing.
-- ---------------------------------------------------------------------------
