...
# Generated for published documents of derived collection dani-demo/python-derivations/customer-metrics
class Document(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(extra='allow')

    active_shipments: typing.Optional[int] = None
    """Number of shipments currently in transit"""
    avg_delivery_days: typing.Optional[typing.Union[int, float]] = None
    """Average days between shipment creation and delivery"""
    customer_id: int
    """Unique identifier for the customer"""
    is_vip: typing.Optional[bool] = None
    """Whether customer qualifies for VIP status (10+ shipments)"""
    last_shipment_date: typing.Optional[str] = None
    """Date of most recent shipment"""
    late_count: typing.Optional[int] = None
    """Number of shipments delivered after expected date"""
    on_time_count: typing.Optional[int] = None
    """Number of shipments delivered on or before expected date"""
    total_shipments: int
    """Total number of shipments for this customer"""
