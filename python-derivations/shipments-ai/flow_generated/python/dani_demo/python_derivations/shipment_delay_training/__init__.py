...
# Generated for published documents of derived collection dani-demo/python-derivations/shipment-delay-training
class Document(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(extra='allow')

    active_shipments: int
    avg_delivery_days: typing.Optional[typing.Union[int, float, None]] = None
    customer_id: int
    label: typing.Literal[0, 1]
    late_count: int
    on_time_count: int
    shipment_id: int
    total_shipments: int
